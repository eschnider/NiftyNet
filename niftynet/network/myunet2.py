...
class MyUNet3D2(TrainableLayer):
    """
    ...
    def __init__(self,
                 ...
                 acti_func='leakyrelu',
                 name='NoNewNet'):
        super(MyUNet3D2, self).__init__(name=name)

        self.n_features = [30, 64, 128]
        self.n_features_down = [8,16,32]
    ...
    def layer_op(self, thru_tensor, is_training=True, **unused_kwargs):
        ...
        # crop 128x128x128 from original 256x256x256 to start
